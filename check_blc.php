...
<head>
    ...
    <title>Check Balance - TSF Bank</title>
        ...
        <div class="container" style="margin-top: 10%; padding:10px 80px 10px 80px; ">
            ...
            <div class="container"
                ...
                <form action="check_blc.php" method="post">
                    <input type="text" class="formin form-control" name="accno" id="" placeholder="Enter Account Number"><br>
                    <br><input class="btn mybtn btn-outline-light" type="submit" value="Submit"><br><br>
                    <p style="color:white;">Don't remember your account number? <a href="all_cust.php">click here</a>
                    </p>
                </form>
            </div>
        </div>
