...
<head>
    ...
    <title>About us - TSF Bank</title>
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
</head>

<body style="background: url(images/bg.jpg); padding-top:8%;>
            ...
            <b>
                <ul class="navbar-nav ">
                    <li class="nav-item nav-links" style="margin-left:15px;">
                        <a class="nav-link text-nowrap" aria-current="page" href="indexphp">Home</a>
                    </li>
    ...
    <center>
        <div class="container" style="margin-top:2%; padding:10px 80px 10px 80px; ">
            ...
            <br>
            <p style="color:slategray;">This website is developed by</p>
            <h1 style="color:palevioletred; text-shadow:2px 2px 2px gray;">CHITRA B L</h1>
            <p style="color:slategray;"><b>Intern at The Sparks Foundation <br> CMR Institute of Technology, Banglore</b></p>
    </center>
