...
<body style="background-image: linear-gradient(steelblue,white,lightpink);">

<div id="lock"><img src="images/rotate.png" alt="" style="width:50%; margin-top:50%;"><br>
<h1 style="color:black; margin-top: 25px;"><b>Please rotate your device</b></h1>
</div>
...
<div id="container">
    ...
    <div class="container-large"
        style="color:mediumvioletred; height:450px; width: 100%; padding:8% 2% 2% 2%">
        <div class="row">
            <div class="col" style="margin-left: 5%;">
                <br><br>&nbsp;<p class="zoomfont"
                    style="font-style: italic; text-shadow:3px 3px 3px grey; text-align:center;"><b>Welcome to <br> TSF
                        Bank!</b></p>
            </div>
