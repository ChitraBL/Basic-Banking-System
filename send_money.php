...
<head>
    ...
    <title>Send money - TSF Bank</title>
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
</head>

<body style="background-color:slategrey; padding-top:8%;">
                    ...
                    <table>
                        ...
                        <tr>
                            <td><input type="text" class="formin form-control" name="accno2" id=""
                                    placeholder="Recipient Account Number"></td>
                        </tr>
                    </table>
                    <br><input class="btn mybtn btn-outline-light" type="submit" value="Transfer"><br><br>
                    <p style="color:white;">Want to check your balance? <a href="check_blc.php">click here</a></p>
                </form>
            </div>
        </div>
